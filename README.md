...
This mod enhances and expands the adult gameplay elements in *Kinky Fight Club 2*, using internal systems already present in the game. It is implemented as a DLL plugin for the BepInEx framework.
...
- Tested with version 1.0 of the game.
- May break with future updates if the internal API changes.

## Notes

- You must legally own *Kinky Fight Club 2* to use this mod.
