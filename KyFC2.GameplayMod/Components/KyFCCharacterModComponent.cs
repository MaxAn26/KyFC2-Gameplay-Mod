...
internal class KyFCCharacterModComponent : MonoBehaviour, IInitializeComponent
{
    ...
    static KyFCCharacterModComponent() => ClassInjector.RegisterTypeInIl2Cpp<KyFCCharacterModComponent>();

    public KyFCCharacterModComponent() : base(ClassInjector.DerivedConstructorPointer<KyFCCharacterModComponent>()) => ClassInjector.DerivedConstructorBody(this);
    ...
    public void Initialize()
    {
        try
        {
            ...
            {
                GameplayMod.Log.Msg("Register class for character");
